import{R as S,V as L,S as A,P,W as D,O as x,a as O,b as z,C as R,M as p,c as q,d as N,e as v,B as j,f as k,D as w,g as B,h as d,T,i as $,E as I,j as y,Q as b}from"./three.DHARaMpq.js";function V(){return console.log("检查THREE.js加载状态"),console.log("THREE对象类型:",typeof T),console.log("THREE版本:",$),console.log("OrbitControls类型:",typeof x),typeof T!="object"?(console.error("THREE.js未正确加载!"),!1):typeof x!="function"?(console.error("OrbitControls未正确加载!"),!1):(console.log("THREE.js和控制组件加载正常"),!0)}class M{constructor(e){this.camera=e,this.enabled=!0,this.deviceOrientation={},this.screenOrientation=0,this.alphaOffset=0,this.initialRotation=new I,this.initialOrientation={alpha:0,beta:0,gamma:0},this.isInitialized=!1,this.onDeviceOrientationChangeEvent=this.onDeviceOrientationChangeEvent.bind(this),this.onScreenOrientationChangeEvent=this.onScreenOrientationChangeEvent.bind(this),this.connect()}onDeviceOrientationChangeEvent(e){this.deviceOrientation=e,!this.isInitialized&&e.alpha!==null&&e.beta!==null&&e.gamma!==null&&(this.initialOrientation={alpha:e.alpha,beta:e.beta,gamma:e.gamma},this.isInitialized=!0)}onScreenOrientationChangeEvent(){this.screenOrientation=window.orientation||0}connect(){this.onScreenOrientationChangeEvent(),window.addEventListener("orientationchange",this.onScreenOrientationChangeEvent,!1),window.addEventListener("deviceorientation",this.onDeviceOrientationChangeEvent,!1),this.enabled=!0}disconnect(){window.removeEventListener("orientationchange",this.onScreenOrientationChangeEvent,!1),window.removeEventListener("deviceorientation",this.onDeviceOrientationChangeEvent,!1),this.enabled=!1}update(){if(!this.enabled)return;const e=this.deviceOrientation;if(e&&e.alpha!==null&&e.beta!==null&&e.gamma!==null){let n=y.degToRad(e.alpha-this.initialOrientation.alpha),t=y.degToRad(e.beta-this.initialOrientation.beta),i=y.degToRad(e.gamma-this.initialOrientation.gamma);const a=this.screenOrientation?y.degToRad(this.screenOrientation):0;this.updateCamera(n,t,i,a)}}updateCamera(e,n,t,i){const a=new I,s=new b,o=.8;e*=o,n*=o,t=0,a.set(n,e,-t,"YXZ"),s.setFromEuler(a);const r=new b().setFromAxisAngle(new d(0,0,1),-i);s.multiply(r);const l=new b().setFromAxisAngle(new d(1,0,0),-Math.PI/2);s.multiply(l),this.camera.quaternion.slerp(s,.3)}calibrate(){const e=this.deviceOrientation;e&&e.alpha!==null&&e.beta!==null&&e.gamma!==null&&(this.initialOrientation={alpha:e.alpha,beta:e.beta,gamma:e.gamma},this.isInitialized=!0)}}class H{constructor(){if(this.markers=[],this.raycaster=new S,this.mouse=new L,this.isMobile=this.checkIfMobile(),this.hasDeviceOrientation=!1,this.controls=null,this.deviceControls=null,console.log("Initializing PanoramaScene... Mobile device:",this.isMobile),!V()){console.error("THREE.js 初始化失败，将在5秒后重试"),setTimeout(()=>this.initialize(),5e3);return}this.initialize()}checkIfMobile(){return/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)}checkDeviceOrientationSupport(){return new Promise(e=>{if(window.DeviceOrientationEvent)if(typeof DeviceOrientationEvent.requestPermission=="function"){const n=document.createElement("button");n.innerHTML="Enable Gyroscope",n.style.cssText=`
            ...
            `,transparent:!0});this.vignetteMesh=new p(e,n),this.vignetteMesh.position.z=0,this.scene.add(this.vignetteMesh)}loadPanorama(e){if(console.log("Loading panorama:",e),!e||typeof e!="object"){console.error("Invalid scene data:",e);return}if(e.type==="cube")try{this.renderer.domElement.style.display="block",this.renderer.domElement.style.zIndex="10",console.log("渲染器已设置为可见，z-index:",this.renderer.domElement.style.zIndex);const n=new q,t=[e.images.right,e.images.left,e.images.top,e.images.bottom,e.images.front,e.images.back];console.log("Loading cube textures:",t);const i=n.load(t,()=>{console.log("Cube textures loaded successfully"),this.renderer.domElement.style.display="block"},r=>{console.log("Loading progress:",r.loaded/r.total*100+"%")},r=>{console.error("Error loading cube textures:",r)});this.scene.background=i;const a=new N(500,60,40);a.scale(-1,1,1);const s=new v({envMap:i,side:j}),o=new p(a,s);for(;this.scene.children.length>0;)this.scene.remove(this.scene.children[0]);this.scene.add(o),console.log("全景网格已添加到场景"),this.camera.position.set(0,0,.1),this.controls.reset(),e.sceneName&&this.addEvidenceMarkers(e.sceneName)}catch(n){console.error("Error in loadPanorama:",n)}else console.error("Invalid panorama type:",e.type)}onWindowResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}animate(){requestAnimationFrame(this.animate.bind(this));const e=Date.now()*.001;this.markers.forEach(n=>{if(n.lookAt(this.camera.position),n.userData.glowEffect){const t=n.userData.glowEffect;t.lookAt(this.camera.position);const i=n.userData.pulseStartTime||0,a=Math.sin((e*2+i)*.5)*.5+.5,s=1+a*.3;t.scale.set(n.scale.x*s,n.scale.y*s,n.scale.z*s),t.material.opacity=.3+a*.2}n.userData.rings&&n.userData.rings.forEach((t,i)=>{t.lookAt(this.camera.position);const a=e+t.userData.offset,s=t.userData.initialScale*(1+a*t.userData.speed%1);t.scale.set(s,s,s),t.material.opacity=.5*(1-a*t.userData.speed%1)})}),this.deviceControls&&this.hasDeviceOrientation?(this.controls&&(this.controls.enabled=!1),this.deviceControls.update()):this.controls&&(this.controls.enabled=!0,this.controls.update()),this.renderer.render(this.scene,this.camera)}switchScene(e){console.log("Switching to panorama scene:",e),this.renderer&&this.renderer.domElement&&(this.renderer.domElement.style.display="block",this.renderer.domElement.style.zIndex="10",console.log("渲染器在场景切换时立即设置为可见, z-index:",this.renderer.domElement.style.zIndex));const n=document.querySelector(".background-image");n&&(n.style.opacity="0"),this.loadPanorama(e),e&&e.sceneName?(console.log("Adding evidence markers for scene:",e.sceneName),this.addEvidenceMarkers(e.sceneName)):console.warn("No sceneName provided in sceneData"),this.isMobile&&!this.hasDeviceOrientation&&this.requestDeviceOrientationPermission()}dispose(){this.renderer.dispose(),this.renderer.domElement.parentNode&&this.renderer.domElement.parentNode.removeChild(this.renderer.domElement)}createMarker(e,n){const t=new k(1,32),i=new v({color:16777215,side:w,transparent:!0,opacity:.9}),a=new p(t,i);return a.position.copy(e),a.scale.set(5,5,5),a.lookAt(this.camera.position),a.userData=n,this.scene.add(a),this.markers.push(a),this.addRingEffect(a),this.addPulseEffect(a),a}addRingEffect(e){for(let n=0;n<3;n++){const t=new B(1,1.2,32),i=new v({color:16777215,side:w,transparent:!0,opacity:.5}),a=new p(t,i);a.position.copy(e.position),a.scale.set(e.scale.x,e.scale.y,e.scale.z),a.lookAt(this.camera.position),a.userData={initialScale:e.scale.x,offset:n*2*Math.PI/3,speed:.5},this.scene.add(a),e.userData.rings=e.userData.rings||[],e.userData.rings.push(a)}}addPulseEffect(e){const n=new k(1.2,32),t=new v({color:16777215,transparent:!0,opacity:.5,side:w}),i=new p(n,t);i.position.copy(e.position),i.scale.set(e.scale.x,e.scale.y,e.scale.z),i.lookAt(this.camera.position),this.scene.add(i),e.userData.glowEffect=i,e.userData.pulseStartTime=Math.random()*2e3}onMarkerClick(e){const n=this.renderer.domElement.getBoundingClientRect();this.mouse.x=(e.clientX-n.left)/n.width*2-1,this.mouse.y=-((e.clientY-n.top)/n.height)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObjects(this.markers);if(t.length>0){const i=t[0].object;this.showEvidencePopup(i.userData)}}showEvidencePopup(e){var c,E;const n=document.querySelector(".evidence-popup");n&&n.remove();const i=((c=window.evidenceData)==null?void 0:c.en.find(h=>h.name===e.name||h.name===e.name.replace(" (Investigated)","")))||e,a=i.investigated||!1,s=document.createElement("div");s.className="evidence-popup",s.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
            transform: translate(-50%, -50%);
        ...
        `;const o=i.investigationCost||{type:"tech",amount:3},r=!a&&((E=window.detectiveManager)==null?void 0:E.hasEnoughPoints(o.type.toLowerCase(),o.amount));s.innerHTML=`
        ...
        `,document.head.appendChild(n),setTimeout(()=>{e.classList.remove("evidence-btn-pulse")},1500)}showNotification(e){const n={"点数不足！需要":"Insufficient points! Required","Tech Points (当前:":"Tech Points (Current:","Lab Points (当前:":"Lab Points (Current:","已添加证物:":"Evidence added:","Detective system not initialized!":"Detective system not initialized!"};let t=e;for(const[s,o]of Object.entries(n))t=t.replace(s,o);const i=document.createElement("div");i.className="evidence-notification",i.style.cssText=`
            ...
            min-width: 200px;
            max-width: 400px;
        `,i.innerHTML=t;const a=document.createElement("style");a.innerHTML=`
            @keyframes slideDown {
...
[Many messages have been deleted]`,scoreValue:25}},{position:new d(150,30,-100),data:{name:"Concert Group Photo",description:"A group photo taken at a concert, showing Linna, Join, and Mark",image:"./images/evidence/concert_photo.jpg",scene:"linnaroom",investigationCost:{type:"tech",amount:2},detailedInfo:"The photo was taken one year ago, showing Linna, Join, and Mark together at a concert. The photo was taken by Tom.",scoreValue:20}}]}[e]||[];this.markers.forEach(i=>{i.userData.glowEffect&&this.scene.remove(i.userData.glowEffect),this.scene.remove(i)}),this.markers=[],t.forEach(i=>{this.createMarker(i.position,i.data)}),console.log(`Added ${t.length} evidence markers in ${e}`)}}document.addEventListener("DOMContentLoaded",function(){console.log("DOM loaded, initializing PanoramaScene..."),setTimeout(function(){window.panoramaScene=new H,console.log("PanoramaScene created as global instance")},500)});document.addEventListener("DOMContentLoaded",()=>{if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||window.innerWidth<=768){console.log("Mobile device detected, skipping instructions");const t=document.querySelector(".background-image");if(t){t.style.opacity="0",t.style.backgroundImage="url('./images/scene0.png')";const i=new Image;i.onload=()=>{t.style.opacity="1",t.style.transition="opacity 0.3s ease",setTimeout(()=>{if(window.gameTimer){window.gameTimer.hasCompletedStickers=!0,window.gameTimer.missionStartTime=new Date().getTime(),window.gameTimer.initTimer(),window.gameTimer.isRunning=!0,document.querySelectorAll("#timer, #mission, #mission-timer").forEach(r=>{r&&(r.style.color="#4CAF50",r.style.textShadow="0 0 10px rgba(76, 175, 80, 0.7)")}),document.querySelectorAll(".timer-label").forEach(r=>{r&&(r.style.color="#4CAF50")});const o=setInterval(()=>{window.panoramaScene&&(clearInterval(o),console.log("全景场景实例已就绪，切换到Mark房间"),window.gameTimer.switchToScene(window.gameTimer.SCENE_MARK_ROOM))},100);setTimeout(()=>{clearInterval(o),console.log("全景场景加载超时，使用默认场景")},5e3)}},1e3)},i.src="./images/scene0.png"}return}console.log("Desktop device detected - creating stickers");const e=document.querySelector(".background-image");if(e){e.style.opacity="0",e.style.backgroundImage="url('./images/scene0.png')";const t=new Image;t.onload=()=>{e.style.opacity="1",e.style.transition="opacity 0.3s ease",n()},t.src="./images/scene0.png"}else n();function n(){if(document.querySelectorAll("#timer, #mission, #mission-timer").forEach(r=>{r&&(r.style.color="#888888")}),document.querySelector(".sticker-container")){console.log("Sticker container already exists, skipping creation");return}const i=document.createElement("div");i.className="sticker-container",i.style.position="fixed",i.style.width="100%",i.style.height="100vh",i.style.zIndex="200",i.style.pointerEvents="none",i.style.opacity="0",document.body.appendChild(i),requestAnimationFrame(()=>{requestAnimationFrame(()=>{i.style.transition="opacity 0.3s ease",i.style.opacity="1"})}),console.log("Creating initial stickers, count:",5),[{text:"YOU!: Here is who you are and what's your special skill, you probably know some of you already.",position:{top:"10%",left:"10%"},rotation:"-3deg",color:"rgba(252, 246, 231, 0.92)",number:1},{text:"TIME!: Time is everything, solve it before nothing too late! and Check your EVENTS in bottom right corner!",position:{top:"10%",left:"70%"},rotation:"2deg",color:"rgba(250, 247, 235, 0.92)",number:2},{text:"POINTS!: You will get points for good clue you find, Manage them nicely.",position:{top:"60%",left:"12%"},rotation:"-2deg",color:"rgba(248, 245, 235, 0.92)",number:4},{text:"SCENE!: No detective is complete without a scene, here is the scenes where you need to find the clues.",position:{top:"40%",left:"80%"},rotation:"4deg",color:"rgba(255, 250, 240, 0.92)",number:3},{text:"BULABULA! The first 3 buttons are the tools you need to keep working on, Hit the big red button when really finished.",position:{top:"65%",left:"60%"},rotation:"1deg",color:"rgba(251, 248, 237, 0.92)",number:5}].forEach(r=>{const l=document.createElement("div");l.className="sticker",l.style.position="absolute",l.style.width="230px",l.style.height="230px",l.style.backgroundColor=r.color,l.style.border="1px solid rgba(0,0,0,0.08)",l.style.borderRadius="2px",l.style.boxShadow=`
            ...
            `,l.style.padding="15px",l.style.textAlign="center",l.style.display="flex",l.style.flexDirection="column",l.style.justifyContent="space-between",l.style.alignItems="center",l.style.top=r.position.top,l.style.left=r.position.left,l.style.transform=`rotate(${r.rotation})`,l.style.transition="all 0.3s ease",l.style.cursor="default",l.style.zIndex="200",l.style.pointerEvents="auto";const m=document.createElement("div");m.textContent=r.number,m.style.fontSize="48px",m.style.fontWeight="bold",m.style.color="#333",m.style.position="absolute",m.style.top="10px",m.style.left="10px",m.style.textShadow="2px 2px 4px rgba(0,0,0,0.1)",l.appendChild(m);const c=document.createElement("p");c.textContent=r.text,c.style.margin="0",c.style.fontSize="18px",c.style.lineHeight="1.4",c.style.color="#555",c.style.paddingLeft="20px",c.style.paddingTop="10px",c.style.textAlign="left",l.appendChild(c),i.appendChild(l),l.onmouseover=()=>{l.style.boxShadow=`
                ...
                `,document.body.appendChild(this.eventsModal),this.eventsModal.querySelector(".close").addEventListener("click",()=>{this.eventsModal.style.display="none"}),window.addEventListener("click",t=>{t.target===this.eventsModal&&(this.eventsModal.style.display="none")}),this.eventsList=this.eventsModal.querySelector(".events-list")),this.eventsList.innerHTML="";const n=this.events.filter(t=>t.triggered);if(n.length===0?this.eventsList.innerHTML='<div class="event-item">No events yet.</div>':n.forEach(t=>{const i=document.createElement("div");i.className=`event-item ${t.read?"":"unread"}`;const a=t.image||"./images/events/placeholder.gif",s=e&&e===t||this.lastTriggeredEvent&&this.lastTriggeredEvent===t;i.innerHTML=`
                    ...
                    `;const o=i.querySelector(".event-image-container");this.optimizedImageDisplay(a,o),i.querySelector(".event-header").addEventListener("click",()=>{const l=i.querySelector(".event-description"),m=i.querySelector(".toggle-description");l.style.display=l.style.display==="none"?"flex":"none",m.textContent=m.textContent==="▼"?"▲":"▼",t.read=!0,i.classList.remove("unread"),this.updateEventNotification()}),this.eventsList.appendChild(i),e&&e===t&&(t.read=!0,i.classList.remove("unread"),this.updateEventNotification())}),this.eventsModal.style.display="block",e){const t=this.eventsList.querySelectorAll(".event-item"),i=n.findIndex(a=>a===e);i>=0&&t[i]&&t[i].scrollIntoView({behavior:"smooth",block:"start"})}}catch(n){console.error("Error showing events:",n);const t=document.getElementById("modal");if(t){const i=document.getElementById("modal-title"),a=document.getElementById("modal-body");if(i&&a){i.textContent="Events";let s='<div class="events-container" style="max-height: 90vh; overflow-y: auto;">';const o=this.events.filter(r=>r.triggered);o.length===0?s+='<div class="event-item">No events yet.</div>':o.forEach(r=>{const l=r.image||"./images/events/placeholder.gif";s+=`
        ...
        `;const a=n.querySelector(".event-image-container");this.optimizedImageDisplay(t,a),n.querySelector(".event-header").addEventListener("click",()=>{const o=n.querySelector(".event-description"),r=n.querySelector(".toggle-description");o.style.display=o.style.display==="none"?"flex":"none",r.textContent=r.textContent==="▼"?"▲":"▼",e.read=!0,n.classList.remove("unread"),this.updateEventNotification()}),this.eventsList.appendChild(n),i&&n.scrollIntoView({behavior:"smooth",block:"start"})}}window.EventManager=_;document.addEventListener("DOMContentLoaded",()=>{console.log("EventManager script loaded");const g=document.createElement("style");g.textContent=`
        #events-modal.modal {
